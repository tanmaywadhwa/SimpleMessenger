...
//Disclaimer:-
//
//To write the TODO sections of the code, I took guidance from the official ORACLE Socket
//programming guide.
//The link to the same is :- http://docs.oracle.com/javase/tutorial/networking/sockets/
...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            /*
             * The following code continues to check the incoming server for any new messages and calls 
             * onProgressUpdate as per the working of AsyncTask.  
             */
